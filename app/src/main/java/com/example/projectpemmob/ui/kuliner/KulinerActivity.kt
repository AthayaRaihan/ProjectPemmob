...
class KulinerActivity : AppCompatActivity() {
    ...
    private fun setupCardClickListeners() {
        ...
        findViewById<CardView>(R.id.card_mie_ongklok)?.setOnClickListener {
            openDetailKuliner("Mie Ongklok Abang Adek", "4.6", "Wonosobo, Jawa Tengah")
        }

        findViewById<CardView>(R.id.card_mie_ongklok_2)?.setOnClickListener {
            openDetailKuliner("Mie Ongklok Ibu Bapak", "4.5", "Wonosobo, Jawa Tengah")
        }

        findViewById<CardView>(R.id.card_dawet)?.setOnClickListener {
            openDetailKuliner("Es Dawet Ayu", "4.7", "Wonosobo, Jawa Tengah")
        }

        findViewById<CardView>(R.id.card_sate_buntel)?.setOnClickListener {
